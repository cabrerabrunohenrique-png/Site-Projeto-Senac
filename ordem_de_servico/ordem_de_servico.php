...
<?php
    ...
    $vendor = $listaCodigoProduto->vendedor();
?>
...
<header>
    ...
    <nav>
         <div class ='bg-body-secondary' style="display:flex;justify-content: space-between;">
            ...
            <div class="">
                <a class="letraFundoAzul caixa1 fontemenu text-bg-info  le link-alerta " href="../estoque_entrada.php">Lançamentos -Entrada de Produtos</a>
            </div>
             <div class="">
