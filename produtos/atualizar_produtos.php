...
<header class='' >
    ...
    <div class="bg-body-secondary" style ='display: flex; justify-content: space-between'>
        ...
        <div class="">
            <a class="letraPretoAzul caixa text-bg-primary  fontemenu le link-alerta" href="../card/cart_produto.php" onclick="window.open(this.href, 'popup', 'width=600,height=400'); return false;">Lista de Produtos</a>
        </div>
        <div>
...
<div class='fontemenu' style='display: flex; justify-content: center '>
    ...
    <main >
        ...
        <div class='' style='display: flex; justify-content: space-between'>    
            <div class="col-md-3 ">
                <label for="data" class="form-label dp">Data Alteracao</label>
